...
public class idle_Goblin : StateMachineBehaviour
{
    Transform transform;
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            if (Vector3.Distance(goblin.transform.position, transform_Player.position) < 2)
            {
                animator.SetInteger("isClose_goblin", randint % 2+1);
            }
